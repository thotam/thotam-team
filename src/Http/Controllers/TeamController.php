...
use Thotam\ThotamAuth\DataTables\iCPC1HN_Group_DataTable;
...
class TeamController extends Controller
{
     ...
     * @return void
     */
    public function index_icpc1hn(iCPC1HN_Group_DataTable $dataTable)
    {
        if (Auth::user()->hr->hasAnyPermission(["view-team", "add-team", "edit-team", "delete-team", "set-member-team"])) {
            return $dataTable->render('thotam-team::team-icpc1hn', ['title' => 'Quản lý Đồng bộ - Nhóm']);
        } else {
            return view('errors.dynamic', [
                'error_code' => '403',
                'error_description' => 'Không có quyền truy cập',
                'title' => 'Quản lý Đồng bộ - Nhóm',
            ]);
        }
    }
